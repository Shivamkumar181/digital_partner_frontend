      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0 }}
            className="absolute right-0 mt-3 w-80 bg-[#0f0f0f] border border-gray-800 rounded-2xl shadow-2xl overflow-hidden z-50"
          >
            <div className="px-4 py-3 border-b border-gray-800 text-sm font-semibold text-white">
              Notifications
            </div>
                ...
                <AnimatePresence>
                  {isOpen && (
                    <motion.div
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      exit={{ opacity: 0 }}
                      className="absolute right-0 mt-3 w-52 bg-[#0f0f0f] border border-gray-800 rounded-xl shadow-xl z-50"
                    >
                      <Link
                        to="/settings"
                        className="block px-4 py-2 hover:bg-white/10 text-gray-300"
                ...
                {user && token && (
                  <div className="relative mb-6">
                    <input
                      ...
                      onChange={(e) => setSearchTerm(e.target.value)}
                      placeholder="Search freelancers/clients..."
                      className="w-full px-4 py-3 rounded-xl bg-gray-900 border border-gray-700 text-sm text-gray-100 placeholder-gray-500 focus:outline-none focus:border-indigo-500"
                    />
                    {searchTerm.trim() && (
                      <div className="mt-2 bg-[#0f0f0f] border border-gray-800 rounded-xl max-h-60 overflow-y-auto">
                        {searching ? (
                          <p className="p-3 text-sm text-gray-400">Searching...</p>
                        ) : searchResults.length === 0 ? (
                ...
                {user ? (
                  <div className="border-t border-gray-800 pt-6">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <button
                        onClick={handleLogout}
                        className="px-4 py-3 rounded-xl text-red-400 hover:bg-red-500/10 text-left transition"
                      >
                        Logout
                      </button>
                    </div>
                  ...
                  <div className="flex flex-col gap-3 border-t border-gray-800 pt-6">
                    <Link
                      to="/login"
                      onClick={() => setMobileOpen(false)}
                      className="px-4 py-3 rounded-xl text-gray-400 hover:text-white hover:bg-white/10 transition text-center"
                    >
                      Login
                    </Link>
                    <Link
                      to="/register"
                      onClick={() => setMobileOpen(false)}
                      className="px-4 py-3 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 text-white hover:scale-105 transition text-center"
                    >
                      Sign Up
                    </Link>
                  </div>
